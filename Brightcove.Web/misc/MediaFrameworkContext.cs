...
namespace Sitecore.MediaFramework
{
  ...
  public static class MediaFrameworkContext
  {
    ...
    {
        public static int Width = Settings.GetIntSetting("Sitecore.MediaFramework.DefaultPlayer.Width", 400);
        public static int Height = Settings.GetIntSetting("Sitecore.MediaFramework.DefaultPlayer.Height", 300);
    }

    public static class PreviewSize
    {
        public static int Width = Settings.GetIntSetting("Sitecore.MediaFramework.Preview.Width", 600);
        public static int Height = Settings.GetIntSetting("Sitecore.MediaFramework.Preview.Height", 400);
    }
