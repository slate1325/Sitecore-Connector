namespace Sitecore.MediaFramework.UI.Sublayouts
{
  ...
  public partial class Upload : Page
  {
    ...
    protected virtual Item GetAccountItem()
    {
            ...
            return global::Sitecore.Data.Database.GetDatabase("master").GetItem("{11F15662-0AEE-44EF-A7FA-4E921F4A3C2C}"); //item != null ? AccountManager.GetAccountItemForDescendant(item) : null;
    }
    ...
    protected virtual string GetAccountData()
    {
      ...
      Item accountItem = this.GetAccountItem();
            ...
            var accs = new List<Item>() {accountItem};/*AccountManager.GetAllAccounts(db).Where(AccountManager.IsValidAccount).ToList();
      if (accs.Count == 0)
      {
    ...
    {
            return true;//MediaFrameworkContext.GetUploadExecuter(new ID(accountTemplateId)) != null;
    }
