...
namespace Sitecore.MediaFramework.Analytics.Dashboard.Layouts.Renderings
{
    ...
    public class ExperienceAnalyticsListControlViewModel : DvcRenderingModel
    {
        ...
        public override void Initialize(Rendering rendering)
        {
            ...
            base.Control.Requires.Script("/sitecore/shell/client/Applications/ExperienceAnalytics/Common/Layouts/Renderings/Brightcove/ExperienceAnalyticsListControl.js");
            ...
            foreach (Item item in items)
            {
                ...
                object numberScaleObject = null;

                try
                {
                    numberScaleObject = DvcRenderingModel.GetNumberScaleObject(item.ID);
                }
                catch
                {
